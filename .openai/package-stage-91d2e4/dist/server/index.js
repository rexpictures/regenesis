...
function getDraftSecret() {
	return "be1c7479-c8c2-4b83-adf6-63233dd336b8";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "c596f0f8-ff34-439a-9293-8383c21505f2";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "c596f0f8-ff34-439a-9293-8383c21505f2") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "c596f0f8-ff34-439a-9293-8383c21505f2",
		rootBoundaryId
	});
}
/**
