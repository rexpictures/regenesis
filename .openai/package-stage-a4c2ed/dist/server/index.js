globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-Cse-4cIF.js","assets/layout-segment-context-CLBEuNPH.js"];
...
function getDraftSecret() {
	return "31cbdf66-71ba-440e-a589-819d9bc7050c";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "328600ce-b8f9-483c-80bf-3d503e1105dd";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "328600ce-b8f9-483c-80bf-3d503e1105dd") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "328600ce-b8f9-483c-80bf-3d503e1105dd",
		rootBoundaryId
	});
}
/**
...
async function generateMetadata() {
	...
	const image = host ? `${protocol}://${host}/og.png` : void 0;
	return {
		title: "Regenesis — Creating a New Beginning",
		description: "Three landing page directions for Regenesis, a whole-person program supporting lasting change.",
		icons: {
			icon: "/favicon.svg",
		...
		openGraph: image ? {
			...
			images: [{
				...
				width: 1200,
				height: 630,
				alt: "Regenesis — The Will to Be Well"
			}]
		} : void 0,
		twitter: image ? {
...
var __publicFiles = new Set([
	...
	"/file.svg",
	"/globe.svg",
	"/images/blue-orange-twilight.jpg",
	"/images/blue-sky.jpg",
	"/images/sunrise-mountains.jpg",
	"/og.png",
	"/window.svg"
]);
